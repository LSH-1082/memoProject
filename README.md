...
- 초기에는 사용자 인터페이스가 직관적이지 않았고 모바일 환경에서 사용이 어려워 접근성과 활용도가 떨어졌습니다.

- 이를 개선하기 위해 다양한 메모 앱의 기능을 참고하고 카테고리와 페이지 구성을 도입하여 메모를 체계적으로 관리할 수 있도록 했습니다. 또한 마크다운 문법을 지원해 사용자가 다양한 형식으로 메모를 작성할 수 있게 했으며 반응형 웹을 적용해 PC와 모바일 환경 모두에서 일관된 사용자 경험을 제공했습니다.

- 반응형 CSS와 UI와 UX 설계의 중요성을 체감했으며 단순히 기능 구현을 넘어서 실제 사용자 입장에서 편리하게 사용할 수 있는 화면 구성이 무엇인지 고민할 수 있었습니다. 이후에는 버튼 색상과 시각적 구분 요소를 보다 세밀하게 설계하여 더욱 직관적인 UI와 UX를 구현할 계획입니다.
